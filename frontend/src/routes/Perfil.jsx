          ...
          <tr>
            ...
            <td>
              {isEditing ? (
                ...
                <span>
                  {String(editableUser.rut).slice(0, -1)}-
                  {String(editableUser.rut).slice(-1)}
                </span>
              )}
            </td>
          </tr>
            ...
            <td>
              {isEditing ? (
                <input
                  ...
                  value={editableUser.fecha_nacimiento}
                  onChange={handleInputChange}
                />
              ) : (
            ...
            <td>
              {isEditing ? (
                <input
                  ...
                  value={editableUser.cuenta_bancaria}
                  onChange={handleInputChange}
                />
              ) : (
                user.cuenta_bancaria
              )}
            </td>
          </tr>
        </tbody>
